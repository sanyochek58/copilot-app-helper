...
- **`ai-service`** – основной ИИ-копилот. Использует Spring AI для взаимодействия с LLM и обрабатывает запросы пользователей. Для проверки токенов обращается к `auth-service`.
